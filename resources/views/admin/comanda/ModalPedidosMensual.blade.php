<!-- Modal -->
<div class="modal fade" id="ReportePedidosMensual" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.comanda.ReportePedidosMes') }}" method="get" target="_blank">
                @csrf
                <div class="form-row">
                    <div class="col-md-12">
