            ...
            <div class="container" style="background-color: white;"><br>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2" hidden>
                        <label for="inputNombre"><strong style="font-size: 16px; color:black;">FACTURADO</strong></label>
                        <div class="form-chek form-check-inline form-switch" style="float: right;">
                            <input type="hidden" class="switch" value="1" name="fact" id="fact">
                            <input class="switch" type='checkbox' value="0" name="fact" id="fact">
                        </div>   
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input class="typeahead form-control" id="seach_cliente" type="text" 
                    ...
                    <div class="form-group col-md-4">
                        <label for="inputNombre">NIT o CI</label>
                        <input class="typeahead form-control" name="Nit_cliente" id="Nit_cliente" type="text" readonly><br>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="inputApellidom">Direccion Domicilio</label>
                        <input class="typeahead form-control" id="Direccion_cliente" type="text" readonly><br>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
     $(document).ready(function() {
        ...
        function agregar() {
            ...
            if (id_plato != "" && cantidad != "" && cantidad > 0 && descuento != "" && Precio_plato != "" && cliente_id != "") {
                if (parseInt(cantidad) > 0 && cliente_id != "") {
