...
<body>
    <div id="divPadre">
        <div id="divHijo">
            ...
            <h2>Ticket de venta {{ $listacomanda->id }}</h2>
            <h2>{{ \Carbon\Carbon::parse($listacomanda->fecha_venta)->format('d-m-Y H:i a') }}</h2>            
        ...
        <div class="ticket centrado">
            <table>
                ...
                <tr>
                    ...
                    <td class="precio">
                    <strong>Bs. {{ number_format($listacomanda->total, 2) }}</strong>
                    </td>
                </tr>
            </table>
        </div>
