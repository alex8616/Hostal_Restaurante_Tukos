      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <table style="width:100%">
              <tr>
                <td><h4 class="card-title">LISTADO DE MENUS</h4></td>
                <td class="text-right">
                  <div class="wrap">
                  </div>
                </td>
            ...
            <div class="table-responsive">
                <table class="table table-bordered shadow-lg mt-4 dt-responsive" id="categoria">
                    ...
                    <thead class="table-head" title="Click to sort">
                        ...
                        <th class="col-head" scope="col"><center>FECHA DEL MENU</center></th>
                    ...
                    <tbody class="table-body">
                            ...
                            <tr class="table-row">
                                ...
                                - ({{ \Carbon\Carbon::parse($menu->fecha_registro)->format('d-m-Y H:i a') }})
                                    ...
                                    <td class="cell" style="font-size: 14px;">
                                        <center>
                                            <form action="{{ route('admin.menu.destroy', $menu) }}" method="POST" class="eliminar-form">
                                                @method('DELETE')
                                                @csrf
                                                <ul class="wrapper" style="height: 50px; display: inline-flex;">                                                 
                                                    <li class="icon spetie" style="padding:4%">
                                                        ...
                                                        <a href="{{ route('admin.menu.show', $menu) }}" style="all: unset;">
