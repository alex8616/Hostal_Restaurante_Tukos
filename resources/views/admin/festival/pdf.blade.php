...
<body>
    <div id="divPadre">
        <div id="divHijo">
            ...
            <h2>Ticket de venta {{ $festival->id }}</h2>
            <h2>{{ \Carbon\Carbon::parse($festival->fecha_venta)->format('d-m-Y H:i a') }}</h2>            
            <strong> Nombre: </strong>Cliente En General<p> 
        </div>
            ...
            <table>
                ...
                <tbody>
                    @foreach ($detallefestivales as $detallefestivale)
                        @if($festival->id == $detallefestivale->registrofestival_id)
                        <tr>
                ...
                <tr>
                    ...
                    <td class="precio">
                    <strong>Bs. {{ number_format($festival->total, 2) }}</strong>
                    </td>
                </tr>
            </table>
        </div>
