    ...
    <div class="card">
        <div class="card-header card-header-black">
            <table style="width:100%">
                <tr>
                    <td><h4 class="card-title">ROL PARA MANEJO DEL SISTEMA</h4></td>
                    <td class="text-right">
                    <div class="wrap">
                    </div>
                    </td>
                    ...
                    <td class="text-right">
                    <div class="wrap">
                        <a  href="{{ route('admin.roles.create') }}" id="addnew" type="button">Añadir</a> 
                    </div>
                    </td>
                </tr>
                </table>
                                        ...
                                        @method('DELETE')
                                            <ul class="wrapper" style="height: 50px; display: inline-flex;">
                                                <li class="icon facebook" style="padding:4%">
                                                    ...
                                                    <a href="{{ route('admin.roles.edit', $role) }}" style="all: unset;">
                                                        <span><i class="fa-solid fa-arrow-up-right-from-square"></i></span>
                                                    </a>
                                                </li>
                                                <li class="icon spetie" style="padding:4%">
                                                <span class="tooltip" style="font-size: 10px;">MOSTRAR</span>
                                                    <a href="{{ route('admin.roles.show', $role) }}" style="all: unset;">
