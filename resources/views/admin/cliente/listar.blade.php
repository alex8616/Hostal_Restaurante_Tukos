      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <table style="width:100%">
              <tr>
                <td><h4 class="card-title">CLIENTES LISTADO</h4></td>
                <td class="text-right">
                  <div class="wrap">
                  </div>
                </td>
            ...
            <div class="table-responsive">
                <table class="table table-bordered shadow-lg mt-4 dt-responsive" id="categoria">
                    ...
                    <thead class="table-head" title="Click to sort">
                        ...
                        <th class="col-head" scope="col"><center>Nombre Cliente</center></th>
                        <th class="col-head" scope="col"><center>Apellido Cliente</center></th>
                        <th class="col-head" scope="col"><center>Direccion</center></th>
                        <th class="col-head" scope="col"><center>Numero De Celular</center></th>
                    ...
                    <tbody class="table-body">
                            ...
                            <tr class="table-row">
                                ...
                                <td class="cell" style="font-size: 14px;">{{$cliente->Nombre_cliente}}</td>
                                <td class="cell" style="font-size: 14px;">{{$cliente->Apellidop_cliente}}</td>
                                <td class="cell" style="font-size: 14px;"><center>{{$cliente->Direccion_cliente}}</center></td>
                                <td class="cell" style="font-size: 14px;"><center>{{$cliente->Celular_cliente}}</center></td>
                                    <td class="cell" style="font-size: 14px;">
                                        <center>
                                            <form action="{{ route('admin.cliente.destroy', $cliente) }}" method="POST" class="eliminar-form">
                                                @method('DELETE')
                                                @csrf
                                                <ul class="wrapper" style="height: 50px; display: inline-flex;">
                                                    <li class="icon facebook" style="padding:4%" data-toggle="modal" data-target="#EditCliente{{ $cliente->id }}">
                                                    ...
                                                    <span class="tooltip" style="font-size: 10px;">MOSTRAR</span>
                                                        <a href="{{ route('admin.cliente.show', $cliente) }}" style="all: unset;">
                            ...
                            @include('admin.cliente.EditCliente')
                            @endforeach
                    </tbody>          
                </table>
            </div>
