      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <table style="width:100%">
              <tr>
                <td><h4 class="card-title">ARTICULOS</h4></td>
                <td class="text-right">
                  <div class="wrap">
                  </div>
                </td>
            ...
            <div class="table-responsive">
                <table class="table table-bordered shadow-lg mt-4 dt-responsive" id="categoria">
                    ...
                    <thead class="table-head" title="Click to sort">
                        ...
                        <th class="col-head" scope="col"><center>Codigo</center></th>
                    ...
                    <tbody class="table-body">
                            ...
                            <tr class="table-row">
                                <td class="cell" style="font-size: 14px;"><center>{{ $articulo->id}}</center></td>
                                <td class="cell" style="font-size: 14px;">{{ ($articulo->Codigo_caja) }}</td>
                                <td class="cell" style="font-size: 14px;">{{ ($articulo->Nombre_Articulo) }}</td>
                                <td class="cell" style="font-size: 14px;">{{ ($articulo->created_at) }}</td>
                                <td class="cell" style="font-size: 14px;">
                                    <center>
                                        <form action="{{ route('caja.destroyarticulo', $articulo) }}" method="POST" class="eliminar-form">
                                            @method('DELETE')
                                            @csrf
                                            <ul class="wrapper" style="height: 50px; display: inline-flex;">
                                                <li class="icon facebook" style="padding:4%" data-toggle="modal" style="padding:6%" data-target="#EditArticulo{{ $articulo->id }}">
                                                    <span class="tooltip" style="font-size: 10px;">EDITAR</span>
                                                    <span><i class="fa-solid fa-arrow-up-right-from-square"></i></span>
                                                </li>
                                                <li class="icon spetie" style="padding:4%" data-toggle="modal" data-target="#ShowArticulo{{ $articulo->id }}">
                            ...
                            @include('admin.caja.ShowArticulo')
                            @include('admin.caja.EditArticulo')
                        @endforeach
                    </tbody>          
                </table>
            </div>
...
<!-- Modal crear plato -->
@include('admin.caja.CrearArticulo')
@endsection
