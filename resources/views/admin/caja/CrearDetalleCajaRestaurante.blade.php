...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form id="add-form" action="{{ route('admin.caja.storedetallecajaRestaurante') }}" method="POST" id="">
                @csrf                    
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-row">
                            <div class="col-md-12">
                                ...
                                <input type="text" value="1" id="codigo_caja_id" name="codigo_caja_id" hidden><br>
                                <p style="font-size: 50px; font-family: Alfa Slab One; text-align: center;">RESTAURANTE</p>
                            </div>
