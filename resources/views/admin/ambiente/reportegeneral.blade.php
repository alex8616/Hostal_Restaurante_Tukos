...
<html lang="en-us">
  ...
  <body>
	...
	<tr>
		...
		<td style="width:60%;">
				<center><h1>REPORTE RESERVAS DE TODOS LOS AMBIENTES EN GENERAL AMBIENTE</h1></center>
		</td>
	</tr>
	</table>
    ...
    <table>
        <tfoot>
            <tr>
                ...
                <td>
                    <strong><p align="center" style="color: blue !important;">Bs. {{ number_format($reservas->sum('total'), 2) }}</p></strong>
                </td>
            </tr>
        </tfoot>
    </table>
