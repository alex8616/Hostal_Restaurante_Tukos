...
<body>
    <div id="divPadre">
        <div id="divHijo">
            @foreach ($pensionados as $tipoCliente) 
                @foreach ($tipoCliente->detalleclientes as $detalleCliente)
                    @if($tipoCliente->id == $comandaMesa->pensionado_id)
                        {{$detalleCliente->cliente->Nombre_cliente}} {{$detalleCliente->cliente->Apellidop_cliente}} <br>
                    @endif
                @endforeach
            @endforeach
