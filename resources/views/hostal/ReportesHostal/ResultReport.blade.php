        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table style="width:100%">
                    <tr>
                        <td><h4 class="card-title">LISTA DE HOSPEDAJES</h4></td>
                        <td></td>
                        <td style="text-align: right;">
                            <a class="btn btn-danger mb-2 mr-2" href="{{route('hostal.reportesHostal.ReporteRangeDate')}}">
                                Exportar PDF <i class="fa-sharp fa-solid fa-download"></i>
                            </a>
                        </td>                           
                    </tr>
                    </table>
                        ...
                        <table class="table table-bordered shadow-lg mt-4 dt-responsive" id="categoria">
                            ...
                            <tbody class="table-body">
                                @php
                                    $i=1;
                                @endphp
                                @foreach ($data as $hospedajehabitacione)
                                @if($hospedajehabitacione->TotalGeneralHospedaje > 0)
                                    <tr class="table-row">
                                        ...
                                        <td class="cell" style="font-size: 14px;">
                                            {{ $hospedajehabitacione->Nombre_habitacion }} <br>                                           
                                        </td>
                                        <td class="cell" style="font-size: 14px;">
                                        ...
                                        @foreach($DetalleHospedajes as $DetalleHospedaje)
                                            @if($DetalleHospedaje->hospedaje_habitacion_id == $hospedajehabitacione->id)
                                                {{$DetalleHospedaje->Nombre_cliente}}<br>
                                            @endif
                                        @endforeach                                       
                                        </td>
                                        <td>
