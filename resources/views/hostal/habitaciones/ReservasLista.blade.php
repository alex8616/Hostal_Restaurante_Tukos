...
<div class="worko-tabs">
    ...
    <div class="tabs flex-tabs">
        <label for="tab-one" id="tab-one-label" class="tab">LISTA DE RESERVAS CONCLUIDOS</label>
        <label for="tab-two" id="tab-two-label" class="tab">LISTA DE RESERVAS EN ESPERA</label>
        <label for="tab-three" id="tab-three-label" class="tab">LISTA DE RESERVAS CANCELADAS</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <table style="width:100%">
                            <tr>
                                <td><h4 class="card-title">LISTA DE RESERVAS - CONCLUIDAS</h4></td>                           
                            </tr>
                            </table>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered shadow-lg mt-4 dt-responsive" id="categoria">
                                    ...
                                    <tbody class="table-body">
                                            ...
                                            @foreach ($reservashabitaciones as $reservashabitacione)
                                                @if($reservashabitacione->Estado_reserva == 'CONCLUIDO')
                                                    <tr class="table-row">
                                                        ...
                                                        <td class="cell" style="font-size: 14px;">
                                                            @foreach ($habitaciones as $habitacione)
                                                                @if($habitacione->id == $reservashabitacione->habitacion_id)         
                                                                    {{ $habitacione->Nombre_habitacion }} <br>
                                                                @endif
                                                            @endforeach 
                                                        </td>
                                                        <td class="cell" style="font-size: 14px;">
                                                            {{ date('Y-m-d', strtotime($reservashabitacione->ingreso_reserva)) }} <strong>-</strong> {{ date('Y-m-d', strtotime($reservashabitacione->salida_reserva)) }}
                                                        </td>                                            
                                                        <td class="cell" style="font-size: 14px;">
                                                            @foreach ($detallereservashabitaciones as $detallereservashabitacione)
                                                                @foreach ($clienteshostal as $cliente)
                                                                    @if($detallereservashabitacione->cliente_id == $cliente->id && $detallereservashabitacione->reserva_habitacion_id == $reservashabitacione->id)         
                                                        ...
                                                        <td class="cell" style="font-size: 14px;"><center>Bs. {{ number_format($reservashabitacione->TotalGeneralHospedaje_reserva, 2) }}</center></td>                                                                              
                                                            <td class="cell" style="font-size: 14px;">
                                                                <center>
                                                                    <form action="#" method="POST" class="eliminar-form">
                                                                        ...
                                                                        <ul class="wrapper" style="height: 50px; display: inline-flex;">
                                                                            <li class="icon facebook" style="padding:4%" data-toggle="modal" data-target="#MostrarPdfReserva{{ $reservashabitacione->id }}">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <table style="width:100%">
                            <tr>
                                <td><h4 class="card-title">LISTA DE RESERVAS - EN ESPERA</h4></td>                           
                            </tr>
                            </table>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered shadow-lg mt-4 dt-responsive" id="categoria">
                                    ...
                                    <tbody class="table-body">
                                            ...
                                            @endphp
                                            @foreach ($reservashabitaciones as $reservashabitacione)
                                                @if($reservashabitacione->Estado_reserva == 'INGRESO')
                                                    <tr class="table-row">
                                                        <td class="cell" style="font-size: 14px;"><center>{{ $i++ }}</center></td>
                                                        <td class="cell" style="font-size: 14px;">
                                                            @foreach ($habitaciones as $habitacione)
                                                            ...
                                                            <td class="cell" style="font-size: 14px;">
                                                                <center>
                                                                    <form action="#" method="POST" class="eliminar-form">
                                                                        ...
                                                                        @csrf
                                                                        <ul class="wrapper" style="height: 50px; display: inline-flex;">
                                                                            <li class="icon facebook" style="padding:4%" data-toggle="modal" data-target="#MostrarPdf{{ $reservashabitacione->id }}">
                                                                                <span class="tooltip" style="font-size: 10px;">IMPRIMIR</span>
                                                                                <span><i class="fa-solid fa-print"></i></span>
                                                                            </li>
                                                                            <button>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered shadow-lg mt-4 dt-responsive" id="categoria">
                                    ...
                                    <tbody class="table-body">
                                            ...
                                            @endphp
                                            @foreach ($reservashabitaciones as $reservashabitacione)
                                                @if($reservashabitacione->Estado_reserva == 'ELIMINADO')
                                                    <tr class="table-row">
                                                        <td class="cell" style="font-size: 14px;"><center>{{ $i++ }}</center></td>
                                                        <td class="cell" style="font-size: 14px;">
                                                            @foreach ($habitaciones as $habitacione)
                                                        ...
                                                        <td class="cell" style="font-size: 14px;">
                                                            {{ date('Y-m-d', strtotime($reservashabitacione->EliminadoIngreso)) }} <strong>-</strong> {{ date('Y-m-d', strtotime($reservashabitacione->EliminadoSalida)) }}
                                                        </td>                                            
                                                        <td class="cell" style="font-size: 14px;">
                                                            @foreach ($detallereservashabitaciones as $detallereservashabitacione)
                                                                @foreach ($clienteshostal as $cliente)
