...
<script>
    ...
    function agregar() {
        var datosProducto = document.getElementById('cliente_id').value.split('_');
        var cliente_id = datosProducto[0];
        var identificacion = document.getElementById('Documento_cliente').value;
        var nombre = document.getElementById('Nombre_cliente').value;
        var nacionalidad = document.getElementById('Nacionalidad_cliente').value;
        var profesion = document.getElementById('Profesion_cliente').value;
        var edad = document.getElementById('Edad_cliente').value;
        var estadoCivil = document.getElementById('EstadoCivil_cliente').value;
        ...
        if (cliente_id != "") {
            ...
            '"><td class="text-center">' + cont + '</td><td>' + identificacion + '</td><td>' + nombre + '</td><td>' + nacionalidad + '</td><td>' + profesion + '</td><td>' + edad + '</td><td>' + estadoCivil + '</td><td class="text-center"><button type="button" class="btn btn-danger btn-sm" onclick="eliminar(' + cont +
            ');"><i class="zmdi zmdi-close"></i></button></td></tr>';
            cont++;
            $('#detalles').append(fila);
            ...
            // Obtener el contenido HTML completo de la tabla
            var tablaHtml = $('#detalles').html();
            // Mostrar la información de la tabla en el div correspondiente
            $('#info-tabla').html('ID Cliente: ' + cliente_id + '<br>' + 'Identificación: ' + identificacion + '<br>' + 'Nombre: ' + nombre + '<br>' + 'Nacionalidad: ' + nacionalidad + '<br>' + 'Profesión: ' + profesion + '<br>' + 'Edad: ' + edad + '<br>' + 'Estado civil: ' + estadoCivil);
        } else {
            Swal.fire({
            icon: 'error',
            title: 'Lo siento',
