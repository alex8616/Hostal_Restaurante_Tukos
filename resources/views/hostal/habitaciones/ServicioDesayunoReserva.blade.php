<!-- Modal -->
<div class="modal fade bd-example-modal-sm" id="modelServicioDesayuno" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
<br><br>
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-body">
                    <div class="card-profile2">
                    <div class="card-profile2_visual2"></div>
                    <form action="{{ route('hostal.habitacion.ServicioDesayuno') }}" method="POST">
                    @csrf
                    <div class="card-profile2_user-infos">
                        <span class="infos_name2">REGISTRAR DESAYUNO</span>
                        <span class="infos_nick2"><?php  ?></span>    
                            ...
                            <input type="text" id="servicio_hostals_id" name="servicio_hostals_id" value="1" hidden>
 ...
 * {
 ...
 .card-profile2_visual2:before, .card-profile2_visual2:after {
	 display: block;
	 content: '';
	 width: 100%;
	 height: 100%;
 ...
 .card-profile2_visual2:before {
	 filter: grayscale(100%);
}
.card-profile2_user-infos {
	 position: absolute;
	 z-index: 3;
	 left: 0;
	 right: 0;
 ...
 .card-profile2_user-infos a:after {
	 content: '';
	 font-style: normal;
	 position: absolute;
	 width: 100%;
 ...
 .card-profile2_user-infos .infos_name2, .card-profile2_user-infos .infos_nick2 {
	 display: block;
 ...
 .card-profile2_user-infos .infos_nick2 {
	 top: 32px;
	 font-size: 14px;
	 font-weight: 300;
}
 .card-profile2_user-stats {
	 background: #fff;
	 float: left;
	 width: 100%;
 ...
 .card-profile2_user-stats .stats-holder {
	 position: absolute;
	 width: 100%;
	 top: calc(70% + 4em);
	 display: flex;
}
 .card-profile2_user-stats .user-stats {
	 flex: 1;
	 text-align: center;
}
 .card-profile2_user-stats .user-stats strong {
	 display: block;
	 float: left;
	 clear: both;
	 width: 100%;
 ...
 .card-profile2_user-stats .user-stats span {
	 font-size: 26px;
	 color: #5e5e5e;
	 padding: 0.18em 0;
	 display: inline-block;
