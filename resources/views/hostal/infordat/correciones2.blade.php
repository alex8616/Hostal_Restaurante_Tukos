            ...
            <form action="#" method="POST" id="add_employee_form" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="col-md-4">
                        ...
                        <input class="otraclase" id="Documento_cliente" name="Documento_cliente" type="text" 
                        name="Nombre_cliente" onkeyup="javascript:this.value=this.value.toUpperCase();">
                        <input class="otraclase" id="cliente_id" type="text" 
                    ...
                    <div id="form_cliente" style="display:none;">
                        <div class="col-md-4">
                            ...
                            <input class="otraclase" name="Nombre_cliente" 
                            id="Nombre_cliente" type="text">
                        </div>
                        <div class="col-md-4">
                            <label for="Apellido_cliente">Apellidos</label>
                            <input class="otraclase" name="Apellido_cliente" 
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input class="otraclase" name="Profesion_cliente" 
                            ...
                            <div class="col-md-3">
                                ...
                                <input class="otraclase" name="Edad_cliente" 
