...
<div class="hill"></div>
<div class="wrap">
		<h1>Uh-Oh! No Se Encontro Lo Que Buscaba</h1>
		<p>Estás en medio de la nada. La página que buscabas se movió o no existe.</p>
		<p>Lo que puedes hacer:</p>
		<ul>
			<li> <a onclick="history.back(-1)" class="btn btn-primary">Click Volver atras</a></li>
			<li>Si crees que esto sucedió por error informa al encargado...</li>
		</ul>
	</div>
...
<style>
    ...
    .wrap{font:30px 'Carter One', cursive; cursive;color:#777;position:absolute;left:46.5%}
