...
class ComandaMesaController extends Controller
{
    ...
    public function pdf(ComandaMesa $comandaMesa){
        $pensionados = TipoCliente::with('detalleclientes.cliente')->get();
        ...
        $pdf = PDF::loadView('admin.comandamesa.pdf', compact('pensionados','comandaMesa', 'subtotal', 'detallecomandamesas'))
