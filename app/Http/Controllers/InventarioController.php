...
class InventarioController extends Controller
{
    ...
    public function updateinventarioarticulo(Request $request, $id){
        ...
        $datos = 'Datos anterior -> Buen Estado: '.$activosupdate->Buen_Estado.', Mal Estado: '.$activosupdate->Mal_Estado.', Dañados: '.$activosupdate->Daniado_Estado.', TOTAL: '.$activosupdate->Total_articulo;
        if($sumatotal >= 0 ){
            ...
            if (!empty($request->input('imagenes_base64'))) {
                $photos = []; // Inicializar array para guardar URLs de imágenes
                foreach ($request->input('imagenes_base64') as $imageData) {
                    ...
                    $filename = time() . '_' . uniqid() . '.jpg'; // Generar un nombre de archivo único
            ...
            $activosupdate->save();
            $datosactualizados = 'Datos Nuevo -> Buen Estado: '.$activosupdate->Buen_Estado.', Mal Estado: '.$activosupdate->Mal_Estado.', Dañados: '.$activosupdate->Daniado_Estado.', TOTAL: '.$activosupdate->Total_articulo;
    ...
    public function Articulospdf(){
        ...
        //return view('admin.inventario_cocina.pdf_articulos', compact('articulosArray'));
