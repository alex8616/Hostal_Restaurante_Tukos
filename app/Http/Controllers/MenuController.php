...
class MenuController extends Controller
{
    ...
    public function plantilla(){
            return view('admin.menu.plantilla');
    }
    
    public function plantillatriple(){
        return view('admin.menu.plantillatriple');
    }
    
    public function plantillasemana(){
        return view('admin.menu.plantillasemana');
    }
}
